<script lang="ts">
    ...
    export let schoolName = "Name of the School";
    export let schoolLocation = "Location of the School, Country";
    export let schoolWebsite = "";
    export let degree = "Degree";
    export let degreeDescription: string =
